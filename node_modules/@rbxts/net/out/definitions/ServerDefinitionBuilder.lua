...
do
	...
	function ServerDefinitionBuilder:GetNamespace(groupId)
		...
		assert(_arg0)
		return group.Definitions:_buildServerDefinition(self.globalMiddleware, self.namespace ~= "" and table.concat({ self.namespace, groupId }, ":") or groupId)
	end
	function ServerDefinitionBuilder:Create(remoteId)
		local _self = self
		local item = declarationMap[_self][remoteId]
		remoteId = self.namespace ~= "" and (table.concat({ self.namespace, remoteId }, ":")) or remoteId
