 ...
 */
export declare const CreateSender: <CallArgs extends Array<unknown>>(name: string) => Omit<ServerEvent<[
], CallArgs>, "Connect">;
/**
 ...
 */
export declare type EventDeclaration = readonly [
    name: string,
    ...mw: MiddlewareOverload<unknown[]>
];
declare type InferMiddlewareTypes<T> = T extends [
    string,
    ...MiddlewareOverload<infer A>
] ? ServerEvent<A> : T extends string ? ServerEvent : never;
declare type EventArray<Tuple extends [
    ...defined[]
]> = {
